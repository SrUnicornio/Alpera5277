 ...
 * @date Nov 7 2022
 * @brief Write a function that, given a valid date made with a day d, a month m
 * and a year y, returns its day of the week, that is, “Monday”, or “Tuesday”,
 * or … it is a vowel, if it is a consonant, if it is an uppercase letter, if it
 * is a lowercase letter and if it is a digit.
 * @bug There are no known bugs
 * @see https://kfactorialutge.org/problems/P18777
 */
#include <iostream>
using namespace std;
